...
function VoteOption({ label, sublabel, selected, onSelect, accentColor }) {
  return (
    <label
      onClick={onSelect}
      style={{
    ...
    >
      ...
      <div>
        ...
        {sublabel && <span style={{ fontSize: 13, color: COLORS.midGray, fontFamily: "'DM Sans', sans-serif", marginLeft: 8 }}>{sublabel}</span>}
      </div>
    </label>
  );
}
        ...
        <div style={{ background: COLORS.white, borderRadius: 16, padding: "32px 28px", boxShadow: "0 2px 20px rgba(30,45,61,0.06)" }}>
          ...
          <div style={{ marginBottom: 28 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <VoteOption label="Maddie & Samuel" sublabel="Wright & Ma" selected={presidentVote === "Maddie & Samuel"} onSelect={() => setPresidentVote("Maddie & Samuel")} accentColor={COLORS.red} />
              <VoteOption label="Mostafa & Katelyn" sublabel="Mostafa & Jang" selected={presidentVote === "Mostafa & Katelyn"} onSelect={() => setPresidentVote("Mostafa & Katelyn")} accentColor={COLORS.red} />
